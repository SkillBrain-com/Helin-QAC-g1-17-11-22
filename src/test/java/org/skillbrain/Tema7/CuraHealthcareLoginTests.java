...
public class CuraHealthcareLoginTests extends Utils{
    WebDriver driver;
    ...
    public void loginWithCredentials(String username, String password, String credentialsType) {
        ...
        usernameInput.sendKeys("Johm Doe");
    ...
    public void verifyRedirectToLoginWhenUserNotLoggedIn() {
        WebElement makeAppointmentButton = driver.findElement(By.xpath("//a[@id='btn-make-appointement']"));
