...
/*
 Definiti un array cu 9 elemente si parcurgeti-l cu structura
 for (tipul de date este la alegere).
...
public class Exercitiul6 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i< arr.length; i++){
            ...
            System.out.println(arr[i]);//am folosit-o ca sa ma conving ca se indeplinesc cerintele taskului
