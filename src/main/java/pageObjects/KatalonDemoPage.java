...
public class KatalonDemoPage {
    ...
    private final static String SELECT_COMBO_FACILITY= "combo_facility";
    private final static String SELECT_COMBO_FACILITY_TOKYO = "option[value='Tokyo CURA Healthcare Center']";
    private final static String SELECT_COMBO_FACILITY_HONGKONG = "//option[@value='Hongkong CURA Healthcare Center']";
    ...
    private final static String TXT_VISIT_DATE = "txt_visit_date";
    ...
    private final static String BTN_BOOK_APPOINTMENT = "btn-book-appointment";
    ...
    public WebElement btnBookAppointment;
    ...
    @FindBy(xpath = SELECT_COMBO_FACILITY_HONGKONG)
    ...
    @FindBy(xpath = SELECT_COMBO_FACILITY_TOKYO)
    ...
    @FindBy(id = SELECT_COMBO_FACILITY)
    public WebElement selectComboFacility;
